...
def optimize_prefs(fo: Options, browser_params) -> None:
    ...
    * https://github.com/pyllyukko/user.js/blob/master/user.js
    ...
    # Additional preferences, Strict
    # fo.set_preference("browser.contentblocking.category", "strict");
    # fo.set_preference("privacy.fingerprintingProtection", True);
    # fo.set_preference("privacy.trackingprotection.emailtracking.enabled", True);
    # fo.set_preference("privacy.trackingprotection.enabled", True);
    # fo.set_preference("privacy.trackingprotection.socialtracking.enabled", True);

    # Additional preferences, Custom
    # fo.set_preference("browser.contentblocking.category", "custom");
    # fo.set_preference("network.cookie.cookieBehavior", 0);
    # fo.set_preference("privacy.fingerprintingProtection.pbmode", False);
    # fo.set_preference("privacy.trackingprotection.cryptomining.enabled", False);
    # fo.set_preference("privacy.trackingprotection.emailtracking.pbmode.enabled", False);
    # fo.set_preference("privacy.trackingprotection.fingerprinting.enabled", False);
    # fo.set_preference("privacy.trackingprotection.pbmode.enabled", False);
